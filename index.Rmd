...
-  Music of all genres tends to have a positive influence on mental health. Gospel and lo-fi stand out for their consistently uplifting effects, while classical, pop, rap, rock, and even video game soundtracks generally promote well-being—with only rare instances where they might negatively impact certain mental health conditions.
...
interactive_plot <- interactive_plot %>% 
  layout(title = "Impact of Daily Hours on Mental Health")
